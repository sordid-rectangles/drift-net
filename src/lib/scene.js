 ...
 * @param { JSON } posts Grabbed post map from the backend
 */
export const createScene = (el, map) => {
    ...
    if (map) {
        ...
        for( var[slug, id] of map.entries() ) { 
            ...
            const articleCube = new THREE.Mesh(articleBox, new THREE.MeshBasicMaterial({color: 0x000000}));
